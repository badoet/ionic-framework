...
export { initialize } from './global/syg-global';
export { componentOnReady } from './utils/helpers';
export { isPlatform, Platforms, PlatformConfig, getPlatforms } from './utils/platform';
export { SygSafeString } from './utils/sanitization';
export { SygicConfig, getMode, setupConfig } from './utils/config';
...
export { SygSwiper } from './components/slides/SygSwiper';

...
import { IonAlert } from '@ionic/core/components/syg-alert.js'
import { IonActionSheet } from '@ionic/core/components/syg-action-sheet.js'
...
const alertController = /*@__PURE__*/ createController('syg-alert', IonAlert, alertCtrl);
const actionSheetController = /*@__PURE__*/ createController('syg-action-sheet', IonActionSheet, actionSheetCtrl);
